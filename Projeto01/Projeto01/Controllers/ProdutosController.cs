    ...
    public class ProdutosController : Controller
    {
        ...
        private void PopularViewBag(Produto produto = null)
        {
            if (produto == null)
            {
                ...
                ViewBag.FabricanteId = new SelectList(fabricanteServico.ObterFabricanteClassificadasPorNome(), "FabricanteId", "Nome");
            }
            else
            {
                ...
                ViewBag.FabricanteId = new SelectList(fabricanteServico.ObterFabricanteClassificadasPorNome(), "FabricanteId", "Nome", produto.FabricanteId);
            }
        }
